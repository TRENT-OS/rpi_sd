...
//	timer_list		timer;		/* Timer for timeouts */
	...
	sg_mapping_iter_t		sg_miter;	/* SG state for PIO */
	...
	mmc_request_t		*mrq;			/* Current request */
	mmc_command_t		*cmd;			/* Current command */
	mmc_data_t		*data;			/* Current data request */
...
#define write(val,reg) 		(write32 (ARM_SDHOST_BASE + reg, val))
#define read(reg) 			(read32 (ARM_SDHOST_BASE + reg))
